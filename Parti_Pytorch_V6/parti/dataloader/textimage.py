...
class TextImageBase(Dataset):
    ...
    def __getitem__(self, ind: int) -> Tuple[Any, Any]:
        ...
        return {'image': image_tensor, 'text_token': tokenized_text}
...
class TextImageTrain(TextImageBase):
    def __init__(self, folder: str,
        ...
        super().__init__(folder, 'train', self.tokenizer, transform)
...
class TextImageValidation(TextImageBase):
    def __init__(self, folder: str,
        ...
        super().__init__(folder, 'valid', self.tokenizer, transform)
